...
<head>
    ...
    <link href="css/passwordremainderstyle.css" rel="stylesheet " type="text/css">
</head>
<body background="images/lucifer1.jpg">
        ...
        <form class="login-form" action="/ChangePassword" method="post">
            ...
            <div class="password-wrapper">
                <label class="ui-label ui-input-label hybrid-password login-input login-input-password">
                    <span class="ui-label-text">Enter your password:</span>
